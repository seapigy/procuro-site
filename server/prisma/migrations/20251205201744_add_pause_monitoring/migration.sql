...
INSERT INTO "new_Item" ("category", "createdAt", "estimatedMonthlyUnits", "firstPurchasedAt", "id", "isMonitored", "isVagueName", "lastCheckedPrice", "lastPaidPrice", "lastPurchasedAt", "matchConfidence", "matchedPrice", "matchedRetailer", "matchedUrl", "name", "needsClarification", "priorityScore", "purchaseCount", "quantityPerOrder", "reorderIntervalDays", "sku", "upc", "updatedAt", "userId", "vendorName") SELECT "category", "createdAt", "estimatedMonthlyUnits", "firstPurchasedAt", "id", "isMonitored", "isVagueName", "lastCheckedPrice", "lastPaidPrice", "lastPurchasedAt", "matchConfidence", "matchedPrice", "matchedRetailer", "matchedUrl", "name", "needsClarification", "priorityScore", "purchaseCount", "quantityPerOrder", "reorderIntervalDays", "sku", "upc", "updatedAt", "userId", "vendorName" FROM "Item";
DROP TABLE "Item";
